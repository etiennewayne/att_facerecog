                ...
                <div class="column is-10">
                    <div class="box">
                        ...
                        <b-table
                            ...
                            <b-table-column field="salary_level_id" label="ID" sortable v-slot="props">
                            ...
                            <b-table-column label="Action" v-slot="props">
                                <div class="is-flex">
                                    <b-tooltip label="Edit" type="is-warning">
                                        <b-button class="button is-small mr-1" tag="a" icon-right="pencil" @click="getData(props.row.salary_level_id)"></b-button>
                                    </b-tooltip>
                                    <b-tooltip label="Delete" type="is-danger">
                                        <b-button class="button is-small mr-1" icon-right="delete" @click="confirmDelete(props.row.salary_level_id)"></b-button>
                                    </b-tooltip>
                                </div>
                            </b-table-column>
                        </b-table>
                            ...
                            <div class="columns">
                                <div class="column">
                                    <b-field label="Salary" label-position="on-border"
                                             ...
                                             :message="this.errors.salary ? this.errors.salary[0] : ''">
                                        <b-numberinput v-model="fields.salary"
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            const params = [
                ...
                `salarylevel=${this.search.salary_level}`,
                `perpage=${this.perPage}`,
                `page=${this.page}`
            ].join('&')

            this.loading = true
            axios.get(`/get-salary-levels?${params}`)
                .then(({ data }) => {
                    this.data = [];
        ...
        */
        ...
        submit: function(){
            if(this.global_id > 0){
                //update
                axios.put('/salary-level/'+this.global_id, this.fields).then(res=>{
                ...
                //INSERT HERE
                axios.post('/salary-level', this.fields).then(res=>{
        ...
        deleteSubmit(delete_id) {
            axios.delete('/salary-level/' + delete_id).then(res => {
                this.loadAsyncData();
            }).catch(err => {
                if (err.response.status === 422) {
                    this.errors = err.response.data.errors;
        ...
        getData: function(data_id){
            ...
            axios.get('/salary-level/'+data_id).then(res=>{
